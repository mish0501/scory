          ...
          <li class='dropdown light only-icon'>
            ...
            <ul class='dropdown-menu color-settings'>
              ...
              <li class='color-settings-contrast-color'>
                ...
                <a data-change-to="contrast-red" href="#"><i class='fa fa-cog text-red'></i>Червен<small>(по подразбиране)</small></a>
                <a data-change-to="contrast-blue" href="#"><i class='fa fa-cog text-blue'></i>Син</a>
                <a data-change-to="contrast-orange" href="#"><i class='fa fa-cog text-orange'></i>Оранжев</a>
                <a data-change-to="contrast-purple" href="#"><i class='fa fa-cog text-purple'></i>Лилав</a>
                <a data-change-to="contrast-green" href="#"><i class='fa fa-cog text-green'></i>Зелен</a>
                <a data-change-to="contrast-muted" href="#"><i class='fa fa-cog text-muted'></i>Сив</a>
                <a data-change-to="contrast-fb" href="#"><i class='fa fa-cog text-fb'></i>Facebook</a>
                <a data-change-to="contrast-dark" href="#"><i class='fa fa-cog text-dark'></i>Черен</a>
                <a data-change-to="contrast-pink" href="#"><i class='fa fa-cog text-pink'></i>Розов</a>
                <a data-change-to="contrast-grass-green" href="#"><i class='fa fa-cog text-grass-green'></i>Тревно зелен</a>
                <a data-change-to="contrast-sea-blue" href="#"><i class='fa fa-cog text-sea-blue'></i>Морско синьо</a>
                <a data-change-to="contrast-banana" href="#"><i class='fa fa-cog text-banana'></i>Бананово жълто</a>
                <a data-change-to="contrast-dark-orange" href="#"><i class='fa fa-cog text-dark-orange'></i>Тъмно оранжево</a>
                <a data-change-to="contrast-brown" href="#"><i class='fa fa-cog text-brown'></i>Кафяво</a>
              </li>
            </ul>
          </li>
        ...
        var initMessage = $.ajax({
          ...
          if(data[0].id != null){
            for (var i = 0; i < data.length; i++) {
              messages += '<li><a href="/admin/mail/' + data[i].id + '"><div class="widget-body"><div class="pull-left icon"><i class="fa fa-comments text-success"></i></div><div class="pull-left text">' + data[i].name + ' изпрати съобщение <small class="text-muted">' + data[i].time + '</small></div></div></a></li><li class="divider"></li>';
            }
          }
