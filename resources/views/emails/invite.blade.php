                ...
                <table border='0' cellpadding='50' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='600'>
                    <tr>
                        <td align='center' valign='top'>
                            <img height="75" src="{{url('/')}}/admin/assets/images/emails/logo_green.jpg" style="outline:none; text-decoration:none;border:none,display:block;" width="100" />
                        </td>
                    </tr>
                </table>
            </center>
                    ...
                    <tr>
                        <td align='left' style='background: #ffffff; border: 1px solid #dce1e5;' valign='top' width=''>
                            <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                <tr>
                                    <td align='center' valign='top'>
                                        <h1 style='color: #49bf67 !important'>Покана</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' style='border-top: 1px solid #dce1e5;border-bottom: 1px solid #dce1e5;' valign='top'>
                                        <p style='margin:1em 0 1em 0;'>
                                            <strong>Посетете този адрес <a href="{{ url('/register', $invite) }}">{{ url('/register', $invite) }}</a></strong>
                                            <h2>{{ $invite }}</h2>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align='center' height="100px" valign='top'>
                                        <p style='margin:1em 0 1em 0;'>
                                            Ако не успеете, копирайте този адрес и го поставете в браузъра си "{{ url('/register') }}" и въведете кода по горе в полето "Покана".
                                        </p>
                                    </td>
                                </tr>
                            </table>
